class MotoCommuter{
    constructor(){
        this.template = new Vehicle(true, true, '/motorbikes/commuter');
        ...
        //Offset positions
        this.template.tire_left_x_offset = -60;
        this.template.tire_left_y_offset = 7;
        this.template.tire_right_x_offset = 35;
        this.template.tire_right_y_offset = 7;
        this.template.body_x_offset = -70;
        this.template.body_y_offset = -18; //changing this
        this.template.body_x_offset_s = -70;
        this.template.body_y_offset_s = -18;
        this.template.hero_x_offset = 10;
        this.template.hero_y_offset = -18;
