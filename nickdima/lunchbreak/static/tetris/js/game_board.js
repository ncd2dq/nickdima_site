...
class GameBoard{
    ...
    create_saved_dict(){
        let save_dict = {};
        save_dict['L'] = loadImage('http://www.nickdima.com/lunchbreak/static/tetris/assets/L.png');
        save_dict['L_L'] = loadImage('http://www.nickdima.com/lunchbreak/static/tetris/assets/L_L.png');
        save_dict['L_R'] = loadImage('http://www.nickdima.com/lunchbreak/static/tetris/assets/L_R.png');
        save_dict['S_L'] = loadImage('http://www.nickdima.com/lunchbreak/static/tetris/assets/S_L.png');
        save_dict['S_R'] = loadImage('http://www.nickdima.com/lunchbreak/static/tetris/assets/S_R.png');
        save_dict['SQ'] = loadImage('http://www.nickdima.com/lunchbreak/static/tetris/assets/SQ.png');
        save_dict['T'] = loadImage('http://www.nickdima.com/lunchbreak/static/tetris/assets/T.png');
        return save_dict;
    }
