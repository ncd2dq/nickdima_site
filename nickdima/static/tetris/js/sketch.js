...
function preload(){
    ...
    background_sound = loadSound("http://www.nickdima.com/static/tetris/assets/backtrack.mp3");
    background_sound.setVolume(0.6);
    
    place_block_sound = loadSound("http://www.nickdima.com/static/tetris/assets/place_block.mp3");
    place_block_sound.setVolume(0.7);
    
    clear_row_sound = loadSound("http://www.nickdima.com/static/tetris/assets/clear_row.mp3");
